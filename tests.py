...
class ProjectTests(TestCase):
    ...
    def test_product_content(self):
    	...
    	add_product.objects.create(product_Id=1, Productname = "Jungle Book", price=30, stock=55,category="sdf", unit="sdsdf", colour="black" )
    	product_content = add_product.objects.get(id=1)
    	expected_object_name = product_content.Productname
    	self.assertEquals(expected_object_name, 'Jungle Book')
